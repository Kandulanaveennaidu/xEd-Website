      ...
      <section className="container">
        <div className=" grid md:grid-cols-3 py-5">
          ...
          <div className=" py-8 px-4 ">
            ...
            <p className="text-sm">
              Revolutionizing tech, our startup unveils pioneering prototypes.
              PRS harnesses user data, reshaping assessments sans exams or
              interviews. HIMS, at our core, nurtures human intellect from
              birth, preserving potential.
            </p>
            <br />
